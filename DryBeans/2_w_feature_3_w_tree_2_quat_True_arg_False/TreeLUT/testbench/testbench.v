...
reg [127:0] x_test [0:4491];
reg [2:0] y_test [0:4491];

reg [127:0] treelut_input;
wire [27:0] treelut_output;
...
integer i, j;
reg [12:0] result_false;
reg [12:0] result_true;
...
module argmax(input wire [27:0] i, output wire [2:0] o);

wire [3:0] sum [0:6];
assign sum[0] = i[3:0];
assign sum[1] = i[7:4];
assign sum[2] = i[11:8];
assign sum[3] = i[15:12];
assign sum[4] = i[19:16];
assign sum[5] = i[23:20];
assign sum[6] = i[27:24];
