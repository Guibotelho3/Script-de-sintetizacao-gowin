...
class0_adder class0_adder_inst(.i(trees_output[20:0]), .o(treelut_output[5:0]));
class1_adder class1_adder_inst(.i(trees_output[41:21]), .o(treelut_output[11:6]));
...
module argmax(input wire [11:0] i, output wire [0:0] o);
