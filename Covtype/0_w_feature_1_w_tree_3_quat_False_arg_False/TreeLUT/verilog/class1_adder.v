module class1_adder(input wire [14:0] i, output wire [5:0] o);

wire [3:0] stage0_adder0;
wire [2:0] stage0_adder1;
wire [2:0] stage0_adder2;
wire [1:0] stage0_adder3;
 assign stage0_adder0 = i[2:0] + i[4:3];
assign stage0_adder1 = i[6:5] + i[8:7];
assign stage0_adder2 = i[10:9] + i[12:11];
