...
class0_adder class0_adder_inst(.i(trees_output[18:0]), .o(o[6:0]));
class1_adder class1_adder_inst(.i(trees_output[37:19]), .o(o[13:7]));
class2_adder class2_adder_inst(.i(trees_output[54:38]), .o(o[20:14]));
class3_adder class3_adder_inst(.i(trees_output[72:55]), .o(o[27:21]));
class4_adder class4_adder_inst(.i(trees_output[93:73]), .o(o[34:28]));
class5_adder class5_adder_inst(.i(trees_output[118:94]), .o(o[41:35]));
class6_adder class6_adder_inst(.i(trees_output[140:119]), .o(o[48:42]));
