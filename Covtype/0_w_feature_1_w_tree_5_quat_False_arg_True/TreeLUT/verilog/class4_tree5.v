module class4_tree5(input wire [50:0] i, output wire [3:0] o);
...
wire [3:0] new_31;
wire [3:0] new_32;
assign new_32 = i[1] ? 3 : 2;
assign new_31 = i[1] ? 1 : 2;
assign new_30 = i[3] ? 3 : 1;
assign new_29 = i[3] ? 1 : 0;
assign new_28 = i[2] ? 3 : 1;
assign new_27 = i[2] ? 4 : 4;
assign new_26 = i[5] ? 3 : 2;
assign new_25 = i[4] ? 3 : 4;
assign new_24 = i[9] ? 4 : 4;
assign new_23 = i[30] ? 1 : 2;
assign new_22 = i[4] ? 5 : 13;
assign new_21 = i[36] ? 1 : 3;
assign new_20 = i[0] ? 2 : 1;
assign new_19 = i[4] ? 3 : 2;
