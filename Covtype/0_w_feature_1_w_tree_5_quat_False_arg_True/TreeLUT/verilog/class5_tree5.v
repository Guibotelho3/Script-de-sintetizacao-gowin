module class5_tree5(input wire [50:0] i, output wire [2:0] o);
...
wire [2:0] new_25;
wire [2:0] new_26;
assign new_26 = i[3] ? 2 : 3;
assign new_25 = i[9] ? 2 : 0;
assign new_24 = i[1] ? 2 : 0;
assign new_22 = i[8] ? 2 : 0;
assign new_20 = i[1] ? 7 : 1;
assign new_19 = i[31] ? 3 : 1;
