module class2_adder(input wire [15:0] i, output wire [5:0] o);
...
assign stage0_adder1 = i[3:2] + i[6:4];
assign stage0_adder2 = i[9:7] + i[11:10];
assign stage0_adder3 = i[13:12] + i[15:14];
