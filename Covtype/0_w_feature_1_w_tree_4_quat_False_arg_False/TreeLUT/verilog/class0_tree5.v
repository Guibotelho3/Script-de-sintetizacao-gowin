module class0_tree5(input wire [50:0] i, output wire [2:0] o);
...
wire [2:0] new_23;
wire [2:0] new_24;
assign new_24 = i[5] ? 1 : 1;
assign new_23 = i[1] ? 1 : 2;
assign new_22 = i[1] ? 2 : 1;
assign new_21 = i[4] ? 1 : 2;
assign new_20 = i[1] ? 1 : 4;
assign new_19 = i[4] ? 5 : 3;
assign new_18 = i[0] ? 2 : 3;
assign new_17 = i[14] ? 2 : 1;
