module TreeLUT(input wire [431:0] all_features,output wire [41:0] o);
...
class0_adder class0_adder_inst(.i(trees_output[14:0]), .o(o[5:0]));
class1_adder class1_adder_inst(.i(trees_output[29:15]), .o(o[11:6]));
class2_adder class2_adder_inst(.i(trees_output[43:30]), .o(o[17:12]));
class3_adder class3_adder_inst(.i(trees_output[57:44]), .o(o[23:18]));
class4_adder class4_adder_inst(.i(trees_output[72:58]), .o(o[29:24]));
class5_adder class5_adder_inst(.i(trees_output[87:73]), .o(o[35:30]));
class6_adder class6_adder_inst(.i(trees_output[105:88]), .o(o[41:36]));
