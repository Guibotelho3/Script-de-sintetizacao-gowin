module class5_tree6(input wire [50:0] i, output wire [1:0] o);
...
wire [1:0] new_25;
wire [1:0] new_28;
assign new_28 = i[3] ? 0 : 2;
assign new_25 = i[5] ? 2 : 3;
assign new_24 = i[4] ? 2 : 0;
assign new_21 = i[40] ? 3 : 0;
assign new_19 = i[30] ? 3 : 1;
