module class0_tree6(input wire [50:0] i, output wire [1:0] o);
...
assign new_25 = i[1] ? 1 : 0;
assign new_23 = i[4] ? 2 : 1;
assign new_22 = i[3] ? 1 : 2;
assign new_21 = i[5] ? 1 : 0;
assign new_20 = i[1] ? 1 : 0;
assign new_19 = i[4] ? 3 : 0;
assign new_18 = i[0] ? 0 : 1;
assign new_17 = i[25] ? 2 : 0;
