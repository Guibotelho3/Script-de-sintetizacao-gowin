module class3_adder(input wire [20:0] i, output wire [6:0] o);
...
assign stage0_adder1 = i[6:4] + i[9:7];
assign stage0_adder2 = i[12:10] + i[15:13];
assign stage0_adder3 = i[17:16] + i[20:18];
