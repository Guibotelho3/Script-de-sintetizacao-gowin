module class0_tree1(input wire [50:0] i, output wire [3:0] o);
...
wire [3:0] new_41;
wire [3:0] new_42;
assign new_42 = i[2] ? 0 : 1;
assign new_41 = i[0] ? 1 : 1;
assign new_40 = i[0] ? 1 : 1;
assign new_39 = i[6] ? 1 : 2;
assign new_37 = i[2] ? 1 : 0;
assign new_36 = i[9] ? 1 : 1;
assign new_35 = i[3] ? 3 : 1;
assign new_34 = i[1] ? 4 : 0;
assign new_33 = i[4] ? 2 : 0;
assign new_32 = i[3] ? 0 : 2;
assign new_31 = i[3] ? 3 : 2;
assign new_30 = i[8] ? 2 : 5;
assign new_29 = i[6] ? 2 : 5;
assign new_28 = i[0] ? 2 : 1;
assign new_27 = i[8] ? 2 : 3;
assign new_25 = i[46] ? 3 : 4;
