module class4_tree5(input wire [50:0] i, output wire [2:0] o);
...
wire [2:0] new_31;
wire [2:0] new_32;
assign new_32 = i[1] ? 1 : 1;
assign new_31 = i[1] ? 1 : 1;
assign new_30 = i[3] ? 1 : 1;
assign new_29 = i[3] ? 1 : 0;
assign new_28 = i[2] ? 2 : 0;
assign new_27 = i[2] ? 2 : 2;
assign new_26 = i[5] ? 1 : 1;
assign new_25 = i[4] ? 2 : 2;
assign new_24 = i[9] ? 2 : 2;
assign new_23 = i[30] ? 0 : 1;
assign new_22 = i[4] ? 2 : 6;
assign new_21 = i[36] ? 0 : 1;
assign new_20 = i[0] ? 1 : 0;
