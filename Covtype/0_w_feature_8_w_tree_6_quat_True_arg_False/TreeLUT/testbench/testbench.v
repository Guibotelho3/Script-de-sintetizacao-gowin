...
module argmax(input wire [62:0] i, output wire [2:0] o);

wire [8:0] sum [0:6];
assign sum[0] = i[8:0];
assign sum[1] = i[17:9];
assign sum[2] = i[26:18];
assign sum[3] = i[35:27];
assign sum[4] = i[44:36];
assign sum[5] = i[53:45];
assign sum[6] = i[62:54];
